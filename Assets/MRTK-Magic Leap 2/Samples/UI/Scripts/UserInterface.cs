...
namespace MagicLeap.MRTK
{
    public class UserInterface : MonoBehaviour
    {
        ...
        public void GrabSettings()
        {
            ...
            var openxrMeshingProvider = CoreServices.GetSpatialAwarenessSystemDataProvider<MagicLeapOpenXRSpatialMeshObserver>();

            if(mlDeviceManagerProvider == null && handTrackingInputProvider == null && meshingProvider == null && openxrMeshingProvider == null)
            {
            ...
            if (openxrMeshingProvider != null)
            {
                stringBuilder.AppendLine($"OpenXR Meshing Settings:");
                stringBuilder.AppendLine($"\tMeshing Bounds Origin:\t<b>{openxrMeshingProvider.Profile.MeshBoundsOrigin}</b>");
                stringBuilder.AppendLine($"\tMeshing Bounds Rotation:\t<b>{openxrMeshingProvider.Profile.MeshBoundsRotation}</b>");
                stringBuilder.AppendLine($"\tMeshing Bounds Scale:\t<b>{openxrMeshingProvider.Profile.MeshBoundsScale}</b>");
                stringBuilder.AppendLine($"\tMesh Mode:\t<b>{openxrMeshingProvider.Profile.MeshMode}</b>");
                stringBuilder.AppendLine($"\tFill Hole Length:\t<b>{openxrMeshingProvider.Profile.FillHoleLength}</b>");
                stringBuilder.AppendLine($"\tApplied Disconnected Component Area:\t<b>{openxrMeshingProvider.Profile.AppliedDisconnectedComponentArea}</b>");
                stringBuilder.AppendLine($"\tMeshDetectorFlags:\t<b>{openxrMeshingProvider.Profile.MeshDetectorFlags}</b>");
            }
