...
public class SpatialObserverProfileInspecter<T> : BaseMixedRealityToolkitConfigurationProfileInspector where T: ScriptableObject
{
    ...
    protected override void OnEnable()
    {
        ...
        {
            expanded = false;
            if (typeof(T).GetField(property.name,
    ...
    public override void OnInspectorGUI()
    {
        using (new EditorGUI.DisabledGroupScope(IsProfileLock((BaseMixedRealityProfile)target)))
        {
            ...
            {
                EditorGUILayout.ObjectField("Script", MonoScript.FromScriptableObject((T)target), GetType(), false);
            }
