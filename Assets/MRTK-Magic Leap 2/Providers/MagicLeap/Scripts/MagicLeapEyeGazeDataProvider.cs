...
namespace MagicLeap.MRTK.DeviceManagement.Input
{
    ...
    public class MagicLeapEyeGazeDataProvider : BaseInputDeviceManager, IMixedRealityEyeGazeDataProvider, IMixedRealityCapabilityCheck, IMixedRealityEyeSaccadeProvider
    {
        ...
        private bool eyeTrackingPermissionGranted = false;
        private bool eyeTrackingPermissionDenied = false;
...
#region IMixedRealityCapabilityCheck Implementation
        ...
        public override void Enable()
        {
            if (Application.isPlaying)
            {
                ...
                Permissions.RequestPermissions(new string[] { Permissions.EyeTracking }, OnPermissionGranted, OnPermissionDenied, OnPermissionDenied);
            }
        ...
        public override void Update()
        {
            ...
            {
                if (!eyeTrackingPermissionDenied && !eyeTrackingPermissionGranted)
                {
                    Permissions.RequestPermissions(new string[] { Permissions.EyeTracking }, OnPermissionGranted, OnPermissionDenied, OnPermissionDenied);
                }
                ...
                if (MLDevice.IsOpenXRLoaderActive())
                {
                    ...
                    if (hasData)
                    {
                        Vector3 origin = MixedRealityPlayspace.TransformPoint(position);
                        Vector3 worldRotation = MixedRealityPlayspace.TransformDirection(rotation * Vector3.forward);
        ...
        private void OnPermissionDenied(string permission)
        {
            ...
            eyeTrackingPermissionDenied = true;
        }
